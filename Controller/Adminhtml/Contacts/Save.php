...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('The information has been saved.'));
                ...
                $this->messageManager->addException($e, __('Something went wrong while saving the information.'));
            }
